...
4. **Praktikum** - Latihan praktis
5. **Ringkasan** - Poin-poin penting
...
3. **Praktikum**: Alokasikan waktu untuk latihan praktis
4. **Istirahat**: Jangan lupa istirahat setiap 1-1.5 jam
5. **Tanya Jawab**: Sediakan waktu untuk diskusi dan pertanyaan
